 ...
 * ```
 */
export const hasClass = (el: Element | null | undefined, cls: string): string | boolean => {
 ...
 * ```
 */
export const addClass = (el: Element | null | undefined, cls: string) => {
  if (!el) return
 ...
 * ```
 */
export const removeClass = (el: Element | null | undefined, cls: string) => {
  if (!el || !cls) return
  const classes = cls.split(' ')
  let curClass = ' ' + el.className + ' '
 ...
 * ```
 */
export const getBoundingClientRect = (element: Element | null | undefined): DOMRect | number => {
 ...
 * ```
 */
export const getViewportOffset = (element: Element | null | undefined): ViewportOffsetResult => {
  if (!element) {
    return {
      left: 0,
      top: 0,
...
//  * ```
//  */
// export const isInContainer = (el: Element | null | undefined, container: any) => {
